    ...
    public MainFrame() {
        ...
        EXAM.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int totalCheckedContainers = port.getContainerCheckedPriority(priority);
                Result6.setText("Total checked containers for priority " + priority + ": " + totalCheckedContainers);
            }
        });
